        ...
        <div class="container text-center login-box">
            <div class="container mt-5">
                ...
                <form method="POST" action="">
                    ...
                    <a href="visualizarLoginsRS.php?id=<?php echo $id; ?>" class="btn btn-dark">Visualizar LOGINS</a>
                    <a href="cadloginsEmp.php?id=<?php echo $id; ?>" class="btn btn-warning">cadastrar Logins Redes Sociais</a> 
                </form>
            </div>
        </div>
    </div>
